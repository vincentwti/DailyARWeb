...
// node_modules/mind-ar/dist/ui-fBadYuor.js
var c = (a, t) => {
  const i = 2 * Math.PI * t * a;
  return i / (i + 1);
};
var h = (a, t, i) => a * t + (1 - a) * i;
var y = class {
  constructor({ minCutOff: t, beta: i }) {
    this.minCutOff = t, this.beta = i, this.dCutOff = 1e-3, this.xPrev = null, this.dxPrev = null, this.tPrev = null, this.initialized = false;
  }
  reset() {
  ...
  filter(t, i) {
    if (!this.initialized)
      return this.initialized = true, this.xPrev = i, this.dxPrev = i.map(() => 0), this.tPrev = t, i;
...
var v = `<div class="mindar-ui-overlay mindar-ui-loading">
  <div class="loader"/>
</div>
`;
var f = `<div class="mindar-ui-overlay mindar-ui-compatibility">
  <div class="content">
...
`;
var x = `<div class="mindar-ui-overlay mindar-ui-scanning">
  <div class="scanning">
    <div class="inner">
      <div class="scanline"/>
    </div>
...
//# sourceMappingURL=chunk-DG67V5KT.js.map
